 ...
 */
// @Plugin(type = Command.class, headless = true, menuPath =
// "Help>Hello, World!")
public class HelloWorld {
	 ...
	 * as Eclipse or NetBeans), it is most convenient to provide a simple
	 * {@code main()} method that creates an ImageJ context and calls the
	 * plugin.
	 * </p>
	 * <p>
	 ...
	 * {@code inputImage} is the name of the field specifying the input)
	...
	public static void main(final String... args) throws Exception {
		...
		if (knimePath == null) {
			knimePath = System.getProperty("user.home")
					+ "/Desktop/eclipse_knime_2.8.2";
		...
		if (applicationId != null) {
			...
			EclipseAppLauncher appLauncher = new EclipseAppLauncher(context,
					false, true, log);
		...
		// String simplePluginURL = new
		// File("../simple-osgi-plugin/target/simple-osgi-plugin-1.0.0-SNAPSHOT.jar").toURI().toString();
		...
		String simplePluginURL = new File("C:\\Users\\knime-osgi-helper-bundle")
				.toURI().toString();
		Bundle bundle = context.installBundle(simplePluginURL);
//		bundle.update();
		bundle.start();

		ServiceReference reference = (ServiceReference) context
				.getServiceReference("org.knime.ij.wfrecorder.WorkflowCreationService");
		Map<Object, Object> map = (Map<Object, Object>) context
				.getService(reference);

		map.put("C_CreateEmptyWorkflow", null);
		// map.put("C_CreateAndConnectNode", new
		// String[]{"imagej.core.commands.app.EasterEgg", "EasterEgg"});
		// map.put("C_CreateAndConnectNode", new
		// String[]{"imagej.core.commands.app.EasterEgg", "EasterEgg"});
		// map.put("C_CreateAndConnectNode", new
		// String[]{"imagej.core.commands.app.EasterEgg", "EasterEgg"});
